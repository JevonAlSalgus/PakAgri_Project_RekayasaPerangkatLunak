    ...
    <main class="main1" >
        ...
        <section class="hero" id="beranda">
            ...
            <main class="content">
              ...
              <p>"Selamat datang di 'Pak Agri,' sumber panduan pertanian terpercaya. <br> Temukan tips praktis, informasi terkini, dan inspirasi untuk kesuksesan <br>pertanian Anda. Bergabunglah dengan komunitas kami, teman setia <br>petani modern!"</p>
        </section>
        <a href="signin.php" class="cta">Masuk</a>
        <div class="row">
       </main>
      ...
      <div class="content">
          <div class="boxthree">
            <div class="boxt">
              ...
              <h3 class="textisi">Pertanian yang sukses tidak hanya bergantung pada pengetahuan tanaman tertentu, tetapi juga memerlukan</h3>
              <button class="buton" onclick="window.location.href='https://tanjungmeru.kec-kutowinangun.kebumenkab.go.id/index.php/web/artikel/4/394'">Selengkapnya</button>
            </div>
            </div>
            <div class="boxt">
              ...
              <h3 class="textisi">Pertanian yang sukses tidak hanya bergantung pada pengetahuan tanaman tertentu, tetapi juga memerlukan</h3>
              <button class="buton" onclick="window.location.href='https://www.kompas.id/baca/humaniora/2022/06/23/pangan-lokal-untuk-kesehatan-diri-dan-bumi'">Selengkapnya</button>
            ...
            <div class="boxt">
              ...
              <h3 class="textisi">Penyimpanan hasil pertanian memegang peran penting dalam menjaga kualitas dan kuantitas produk</h3>
              <button class="buton" onclick="window.location.href='https://www.healthaffairs.org/doi/10.1377/hlthaff.2015.0647'">Selengkapnya</
              </div>
            </div>
          </div>
      </div>
          ...
          <div class="fitur">
            <div class="fit">
              ...
              <div class="sidef">
                ...
                <button class="tombol"><a href="signup.php">Akses Fitur</a></button>
              </div>
            </div>
            <div class="fit">
              ...
              <div class="sidef">
                ...
                <h3 class="textisi">Anda akan diberikan tips untuk merawat tanaman cabai, tomat dan jagung </h3>
                <button class="tombol"><a href="signup.php">Akses Fitur</a></button>
              </div>
            </div>
          </div>
