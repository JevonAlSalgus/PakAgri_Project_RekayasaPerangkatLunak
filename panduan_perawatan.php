...
<body>
    ...
    <header class="main-header">
        <h1>Panduan Perawatan</h1>
        <h2>Menyajikan Informasi Terbaru dan Praktis untuk Meningkatkan Produktivitas Pertanian Anda</h2>
    </header>
        ...
        <div class="crop-grid">
            ...
            <div class="crop">
                <a href="perawatan_cabe.php">
                    <img src="images/cabe.png" alt="Cabe">
                    <h3>Cabe</h3>
                    <p>Klik untuk melihatnya</p>
                </a>
            </div>
            ...
            <div class="crop">
                <a href="perawatan_semangka.php">
                    <img src="images/semangka.png" alt="Semangka">
                    <h3>Semangka</h3>
                    <p>Klik untuk melihatnya</p>
                </a>
            </div>
            ...
            <div class="crop">
                <a href="perawatan_tomat.php">
                    <img src="images/tomat1.png" alt="Tomat">
                    <h3>Tomat</h3>
                    <p>Klik untuk melihatnya</p>
                </a>
            </div>
            ...
            <div class="crop">
                <a href="perawatan_jagung.php">
                    <img src="images/jagung1.png" alt="Jagung">
                    <h3>Jagung</h3>
                    <p>Klik untuk melihatnya</p>
                </a>
            </div>
            ...
            <div class="crop">
                <a href="perawatan_padi.php">
                    <img src="images/padi.png" alt="Padi">
                    <h3>Padi</h3>
                    <p>Klik untuk melihatnya</p>
                </a>
            </div>
            ...
            <div class="crop">
                <a href="perawatan_selada.php">
                    <img src="images/selada.png" alt="Selada">
                    <h3>Selada</h3>
                    <p>Klik untuk melihatnya</p>
                </a>
            </div>
